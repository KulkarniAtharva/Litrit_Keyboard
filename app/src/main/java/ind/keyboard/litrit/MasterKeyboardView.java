...
public class MasterKeyboardView extends CustomKeyboard
{
    public PopupWindow mChakraPopup;
    public View mPopupParent;
    public Litrit mSwaraChakra;
    private MasterKeyboardActionListener mActionListener;
    ...
    public MasterKeyboardView(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    {
        mActionListener = new MasterKeyboardActionListener();
